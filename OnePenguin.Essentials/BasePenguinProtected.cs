...
namespace OnePenguin.Essentials
{
    ...
    {
        protected void SetRelation(string relation, PenguinReference id) { }

        protected void SetRelations(string relation, List<PenguinReference> ids) { }
        ...
        protected object GetReferenceAttribute(string attribute) { throw new NotImplementedException(); }
